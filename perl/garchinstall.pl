...
system("arch-chroot /mnt/installer-root pacman -Sy xorg xfce4 xorg-xinit xorg-xeyes xf86-video-fbdev xorg-server
    xf86-video-vmware xf86-video-fbdev xf86-input-evdev xf86-input-synaptics weston lightdm perl-gtk3
